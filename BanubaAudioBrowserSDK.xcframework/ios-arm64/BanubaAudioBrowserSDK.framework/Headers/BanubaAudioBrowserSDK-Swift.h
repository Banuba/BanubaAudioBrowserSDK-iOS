...
- (nonnull instancetype)initWithTitle:(NSString * _Nonnull)title titleConfig:(TextConfiguration * _Nonnull)titleConfig message:(NSString * _Nonnull)message messageConfig:(TextConfiguration * _Nonnull)messageConfig buttonTitle:(NSString * _Nonnull)buttonTitle buttonTitleConfig:(TextConfiguration * _Nonnull)buttonTitleConfig buttonColor:(UIColor * _Nonnull)buttonColor buttonCornerRadius:(CGFloat)buttonCornerRadius OBJC_DESIGNATED_INITIALIZER;
/// Title text
...
/// Returns audio browser config. Modify default UI here
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) AudioBrowserConfig * _Nonnull shared;)
+ (AudioBrowserConfig * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
+ (void)setShared:(AudioBrowserConfig * _Nonnull)value;
...
@property (nonatomic, strong) TextConfiguration * _Nonnull myFilesTitleConfiguration;
...
@property (nonatomic, readonly, strong) TextConfiguration * _Nonnull titleConfiguration;
...
@property (nonatomic, readonly, strong) TextConfiguration * _Nonnull stopUsingButtonConfiguration;
/// The view background color
@property (nonatomic, readonly, strong) UIColor * _Nonnull backgroundColor;
- (nonnull instancetype)initWithImageConfiuguration:(ImageConfiguration * _Nonnull)imageConfiuguration titleConfiguration:(TextConfiguration * _Nonnull)titleConfiguration stopUsingButtonTitle:(NSString * _Nonnull)stopUsingButtonTitle stopUsingButtonConfiguration:(TextConfiguration * _Nonnull)stopUsingButtonConfiguration backgroundColor:(UIColor * _Nonnull)backgroundColor OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithTrackTextButtonColor:(UIColor * _Nonnull)trackTextButtonColor activityIndicatorConfig:(SmallActivityIndicatorConfiguration * _Nonnull)activityIndicatorConfig OBJC_DESIGNATED_INITIALIZER;
